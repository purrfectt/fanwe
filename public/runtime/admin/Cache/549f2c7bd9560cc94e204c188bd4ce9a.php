...
<body>
	...
	<table class="form" cellpadding=0 cellspacing=0>
		...
		<tr>
			...
			<td class="item_input">
				<?php echo L("APP_VERSION");?>:<?php echo conf("DB_VERSION");?> <span style='color:#f60; font-size:14px;'>[商业授权]</span></span>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="item_input">
				请访问 <a href="http://www.fanwe.com" target="_blank" title="方维O2O商业系统">http://www.fanwe.com</a>
			</td>
		</tr>
		<tr>
