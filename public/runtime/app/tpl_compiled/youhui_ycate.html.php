...
?>
		...
		<div class="row_list">
			...
			<a href="<?php echo $this->_var['youhui_item']['url']; ?>" title="<?php echo $this->_var['youhui_item']['name']; ?>" class="goods_img_box"><img src="<?php 
$k = array (
  'name' => 'get_spec_image',
...
?>"  alt="<?php echo $this->_var['youhui_item']['name']; ?>" width=160 height=100  class="lazy" /></a>
			</div>
			<div class="row_info f_l">
				<div class="row_title"><a href="<?php echo $this->_var['youhui_item']['url']; ?>" title="<?php echo $this->_var['youhui_item']['name']; ?>"><?php 
$k = array (
  'name' => 'msubstr',
...
?></a></div>
				<div class="blank"></div>
				<div class="row_info_2"><?php echo $this->_var['youhui_item']['brief']; ?></div>
				<div class="blank"></div>
...
?></span>
			...
			<div class="row_btn f_l">
				...
				<span class="row_btn_info"><?php echo $this->_var['youhui_item']['buy_count']; ?><?php echo $this->_var['LANG']['HAS_BUY']; ?></span>
			</div>
...
<div class="short f_r">
<div class="inc">
	<div class="inc_top"><?php echo $this->_var['LANG']['REC_YOUHUI']; ?></div>	
	<div class="inc_main">
