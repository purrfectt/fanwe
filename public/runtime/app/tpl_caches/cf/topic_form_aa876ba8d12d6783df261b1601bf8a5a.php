<?php exit;?>a:3:{s:8:"template";a:6:{i:0;s:110:"C:/Program Files/Apache Software Foundation/Apache2.2/htdocs/fanwe/app/Tpl/fanwe/inc/insert/load_user_tip.html";i:1;s:115:"C:/Program Files/Apache Software Foundation/Apache2.2/htdocs/fanwe/app/Tpl/fanwe/inc/youhui_detail_time_status.html";i:2;s:113:"C:/Program Files/Apache Software Foundation/Apache2.2/htdocs/fanwe/app/Tpl/fanwe/inc/inc_youhui_comment_list.html";i:3;s:102:"C:/Program Files/Apache Software Foundation/Apache2.2/htdocs/fanwe/app/Tpl/fanwe/inc/comment_list.html";i:4;s:107:"C:/Program Files/Apache Software Foundation/Apache2.2/htdocs/fanwe/app/Tpl/fanwe/inc/inc_goods_comment.html";i:5;s:100:"C:/Program Files/Apache Software Foundation/Apache2.2/htdocs/fanwe/app/Tpl/fanwe/inc/topic_form.html";}s:7:"expires";i:1356631189;s:8:"maketime";i:1356627589;}<div class="topic_pub_form">
<textarea class="f-textarea pubform" name="content" id="topic_form_textarea" style="width:700px; height:80px;"></textarea>
<div class="blank"></div>
<div class="f_l">
<span class="form_face form_ico form_face_topic_form_textarea">表情</span>
...
<script type="text/javascript">
		...
		{
			var c = $("#topic_form_textarea").val();
			if(c.length>5000)
			{
				$("#topic_form_textarea").val(c.substr(0,5000));
			}
		}
	$(document).ready(function(){		
		init_topic_form_textarea_form();
	});
function init_topic_form_textarea_form()
{
	$("#topic_form_textarea").bind("change keyup",function(){
			valid_length();
		});	
		...
		$(".form_face_topic_form_textarea").bind("click",function(){
			var obj = this;
			var face_html = $("#face_box_hd_topic_form_textarea").html();
			var face_tab_html = $("#face_box_tab_topic_form_textarea").html();
			$.weeboxs.open(
				face_html, 
				{
					boxid:'form_pop_box',
			...
			bind_topic_form_textarea_set_expression();
		});
		
//		var txt = $("#topic_form_textarea");
...
{
	insert_topic_form_textarea_cnt("[img]"+pos+"[/img]");	
}
function bind_topic_form_textarea_set_expression()
{
	$(".emotion_topic_form_textarea").find("a").bind("click",function(){
		var o = $(this);
		insert_topic_form_textarea_cnt("["+$(o).attr("rel")+"]");	
	});
...
function insert_topic_form_textarea_cnt(cnt)
{
	var val = $("#topic_form_textarea").val();
//	var pos = $("#topic_form_textarea").attr("position");
//	var bpart = val.substr(0,pos);
//	var epart = val.substr(pos,val.length);
//	$("#topic_form_textarea").val(bpart+cnt+epart);
	$("#topic_form_textarea").val(val+cnt);
}
//  获取光标位置
...
<div id="face_box_tab_topic_form_textarea" style="display:none;">
	<ul class="lb_tab">
...
<div id="face_box_hd_topic_form_textarea" style="display:none;">
<div class="blank1"></div>
<div class="emotion emotion_topic_form_textarea qq" f="qq" >
...
<div class="emotion emotion_topic_form_textarea tusiji" f="tusiji" style="display:none;">
